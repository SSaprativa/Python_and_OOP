...
## movie rating is enum representing rating scale 1-5
...
class RatingRegister:
    def __init__(self):
        self._userMovies = {} # {user_id:[list of movies]}
        self._movieRatings = {} # {movie_id:{user_id:rating}}
        self._movies = []
        self._users = []
